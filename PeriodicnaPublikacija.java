...
public class PeriodicnaPublikacija extends Superclass{
...
//KONSTRUKOTRJI
    ...
    public PeriodicnaPublikacija(String Avtor, String Naslov, String Jezik, ArrayList<String> KljucneBesede, String Zvrst, int SteviloStrani, int ID){
    ...
    public PeriodicnaPublikacija(String Avtor, String Naslov, String Jezik, ArrayList<String> KljucneBesede, String Zvrst, int SteviloStrani, boolean Izposojena, boolean Rezervirana, int ID/*boolean NaZalogi*/){

            super(Avtor, Naslov, Jezik, KljucneBesede, Zvrst, Izposojena, Rezervirana);
            this.SteviloStrani= SteviloStrani;
            this.ID = IDstevilo(); //GENERIRANJE ID KNJIGE GLEDE NA ŠTEVILO STRANI in leto
    ...
    public PeriodicnaPublikacija(String Avtor, String Naslov, String Jezik, ArrayList<String> KljucneBesede, String Zvrst, int SteviloStrani, boolean Izposojena, boolean Rezervirana, int ID, int leto , String Skupina){
    ...
    public void izpis(){
        ...
        System.out.println("***   PODATKI O PERIODIČNI PUBLIKACJI   ***");
	...
	public String toString() {
		String niz = "";
		niz += "***   PODATKI O PERIODIČNI PUBLIKACIJI   ***\n";
        ...
        niz += ("Zvrst Knjige: " + this.GetZvrst() + "\n");
    ...
    public static PeriodicnaPublikacija VnesiPeriodicnoPublikacijo() throws Exception {
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		
		System.out.println("\n***   VNOS NOVE PERIODIČNE PUBLIKACIJE   ***\n");
        ...
        switch (stevilo12){
            ...
            System.out.println("Pritisnite (1) za Časopis:");
            System.out.println("Pritisnite (2) za Revija:");
            System.out.println("Pritisnite (3) za Strip:");
            System.out.println("Pritisnite (4) za Krizanka:");
		...
		String kljucnebesede ="";
            ...
            kljucnebesede +=  "Periodicna" + " ";
            kljucnebesede +=  "Publikacija" + " ";
		...
		PeriodicnaPublikacija novaPeriodicnaPublikacija = new PeriodicnaPublikacija(avtor, naslov, jezik, KljucneB, tip, stevilo , false, rezervirana , IDknjiga, leto , skupina);

		System.out.println("Uspesno ste vnesli periodično publikacijo!.");


		return novaPeriodicnaPublikacija;
	}
    ...
    public static PeriodicnaPublikacija preberiIzNiza(ArrayList<String> zapis) {

		PeriodicnaPublikacija novaPeriodicnaPublikacija = new PeriodicnaPublikacija();

	
        try {
                novaPeriodicnaPublikacija.SetAvtor(zapis.get(0));
                novaPeriodicnaPublikacija.SetNaslov(zapis.get(1));
                novaPeriodicnaPublikacija.SetJezik(zapis.get(2));
                novaPeriodicnaPublikacija.SetLeto(Integer.parseInt(zapis.get(3)));
                novaPeriodicnaPublikacija.SetSkupina(zapis.get(4));
                novaPeriodicnaPublikacija.SetKljucneBesede(zapis.get(5));
                novaPeriodicnaPublikacija.SetZvrst(zapis.get(6));
                novaPeriodicnaPublikacija.SetSteviloStrani(Integer.parseInt(zapis.get(7)));
                novaPeriodicnaPublikacija.StanjeArtikla(zapis.get(9).toLowerCase().equals("true") ?  true : false, zapis.get(8).toLowerCase().equals("true") ? true : false );
                novaPeriodicnaPublikacija.SetID(Integer.parseInt(zapis.get(10)));
			...
			System.out.println("Prišlo je do napake v zapisu PER!");
			throw e;
